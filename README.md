...
function Hop()
    ...
    function TPReturner()
        ...
        local ID = ""
        if Site.nextPageCursor and Site.nextPageCursor ~= "
...
local Window = OrionLib:MakeWindow({Name = "INFINITY ROBUX", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "INFINITY ROBUX"})
...
W:AddLabel("[+] INFINITY ROBUX is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "INFINITY ROBUX(Noitification)",
